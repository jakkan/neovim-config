...
function M.config()
  ...
  local on_attach = function(_, bufnr)
    ...
    u.bind(u.normal, "Show implementations list in quickfix window (#lsp)", {"<leader>li"}, vim.lsp.buf.implementation, bufopts)
    u.bind(u.normal, "Show references in the quickfix window (#lsp)", {"<leader>lr"}, vim.lsp.buf.references, bufopts)
    u.bind(u.normal, "Show signature help in floating window (#lsp)", {"<leader>lk"}, vim.lsp.buf.signature_help, bufopts)
